...
{{
  ...
  "overall_assessment": {{
    ...
    "summary": "evidence-first reason and required scope disclaimer"
  }},
  "features": [
    {{
      "feature_id": 1,
